...
3. In this folder, create file libraries.robot and copy the contents from here [libaries.robot](raw/branch/main/02__exercise-consulting-libraries/libraries.robot)
